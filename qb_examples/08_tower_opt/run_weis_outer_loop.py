...
fname_wt_input        = os.path.join(run_dir, "IEA22MWD15_output_driveopt.yaml")
fname_modeling_options = os.path.join(run_dir, "modeling_options_IEA22MW_RWT.yaml")
fname_analysis_options = os.path.join(run_dir, "analysis_options_opt.yaml")

N_OUTER      = 3        # maximum number of outer (fixed-load) iterations
